...
public class ProductCategoriesCounterBolt extends BaseRichBolt {
    ...
    // ITEM:CATEGORY COUNT
    private HashMap<String, Integer> pendingToSave = new HashMap<String, Integer>();
    ...
    public void prepare(Map conf, TopologyContext context, OutputCollector collector) {
        ...
        this.downloadTime = Long.valueOf(conf.get("download-time").toString());
        reconnect();
    }
    ...
    private Integer getProductCategoryCount(String categ, String product){
        ...
        if(count == null){
            ...
            if(sCount == null || "nil".equals(sCount)){
                ...
                count = Integer.valueOf(sCount.toString());
            }
        }
        return count;
    }
    ...
    private Integer count(String product, String categ){
